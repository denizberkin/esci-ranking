...
from utils.preprocess import preprocess_text, levenshtein, levenshtein_norm, additional_features, \
    ...
    process_columns, combined_column, prefix_match, postfix_match
...
if __name__ == "__main__":
    ...
    print("starting additional features!!")
    ...
    feature_columns = []
    feature_columns.extend(levenshtein_cols)
    ...
    feature_columns.extend(["colour_match", "prefix_match", "postfix_match"])
